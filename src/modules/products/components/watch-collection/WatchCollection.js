...
import {getWatchCollection} from "../../../../redux/products/products.actions";
...
let WatchCollection = () => {
    ...
    useEffect(() => {
        // dispatch an action to get men's collection when the page loads
        dispatch(getWatchCollection());
    }, [dispatch]);
            ...
            <section className="p-3 bg-brains">
                <div className="container ">
                    <div className="row animated flipInY">
                        <div className="col">
                            <p className="h3">Watch's Collection</p>
                        </div>
                    </div>
                </div>
            </section>
